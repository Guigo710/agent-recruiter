...
- Todos os caminhos de arquivo devem ser relativos à raiz do projeto com prefixo explícito `data/`. A raiz do projeto é o diretório `agent-recruiter/`.
...
**Responsabilidade**: Buscar vagas de emprego via Firecrawl, que agrega resultados do Indeed, Catho,Nerdin, LinkedIn, Glassdoor, Infojobs e outras fontes.
